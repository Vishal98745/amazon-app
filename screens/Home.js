...
const Home = ({navigation}) => {
  ...
  console.log("the useState work",product);
      ...
      <ScrollView>
        <View style={{ backgroundColor: '#00ced1', padding: 10, flexDirection: 'row', alignItems: 'center' }}>
          ...
          >
            ...
            <TextInput placeholder='Search Amazon.in' style={{ width: 310 }} />
          </Pressable>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5, padding: 10, backgroundColor: "#afeeee" }}>
          ...
          <Pressable>
            <Text style={{ fontSize: 15, fontWeight: '500', color: 'black' }}>Delivery to vishal - Banglore 560021</Text>
          </Pressable>
        ...
        <SliderBox images={images} autoPlay circleLoop dotColor={"#13274f"}
          inactiveDotColor="#90A4AE" ImageCompoentStyle={{ width: '100%' }} />
